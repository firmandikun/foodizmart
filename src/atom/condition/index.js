...
export const Conditions = () => {
  return (
    <div>
      ...
      <div className="" style={{ marginLeft: 32 }}>
        <h5 className="text-left">1. Informasi Pribadi yang kami kumpulkan</h5>
        <p className="text-justify" style={{ marginLeft: 30 }}>
          ...
          <p>
            ...
            pendaftaran penyedia layanan. Ini akan mencakup rincian rekening
            bank anda.
          </p>
          <p>
            Ketika anda menggunakan Aplikasi, anda harus memberikan kami
            informasi yang relevan yang mungkin diperlukan oleh kami agar
            Aplikasi dapat berfungsi, contohnya:
          </p>
          <ol>
            <li>
              Jika anda menggunakan Aplikasi sebagai pengguna, anda harus
              memberikan informasi pada kami sesuai dengan jenis layanan yang
              anda cari, dan rincian alamat pengiriman.{" "}
            </li>
            <li>
              ...
              sebagai penyedia layanan, anda mungkin akan perlu memberikan
              kepada kami data lain yang kami perlukan untuk mengelola Aplikasi
              dan ekosistem terkait, serta untuk memantau keseluruhan penggunaan
              Aplikasi.
            </li>
            <li>
              ...
              pembayar atau pengirim, anda akan menyediakan informasi kepada
              kami yang berkaitan dengan penggunaan, pembayaran atau transfer,
              termasuk tetapi tidak terbatas pada rincian transfer dan/atau
              penerima pembayaran, jumlah pembayaran yang dibayarkan, jenis
              kartu pembayaran dan rekening yang digunakan, nama penerbit kartu
              pembayaran atau akun tersebut, nama pemegang dan nomor kartu
              pembayaran atau rekening tersebut, kode verifikasi kartu
              pembayaran atau rekening dan tanggal kadaluarsa kartu pembayaran
              atau rekening, sebagaimana berlaku.
            </li>
            <li>
              Jika anda bermaksud untuk mendaftar sebagai pemegang akun
              terdaftar atau terverifikasi dari fasilitas uang elektronik yang
              disediakan oleh kami, anda akan memberikan informasi kepada kami
              yang diperlukan termasuk tetapi tidak terbatas pada nama lengkap
              anda, nomor kartu identitas anda, jenis kartu identitas yang anda
              gunakan untuk registrasi, alamat, jenis kelamin, tempat dan
              tanggal lahir, pekerjaan, rincian pajak, kebangsaan dan/atau data
              biometrik.
            </li>
            <li>
              ika anda bermaksud untuk menambahkan kartu pembayaran atau
              rekening sebagai sumber dana untuk pembayaran dalam Aplikasi, anda
              akan memberikan kepada kami informasi terkait jenis kartu
              pembayaran dan rekening yang didaftarkan, penerbit kartu
              pembayaran atau rekening, nama pemegang kartu pembayaran dan
              rekening tersebut, nomor identifikasi dari kartu pembayaran atau
              rekening tersebut dan kode verifikasi kartu pembayaran atau
              rekening dan tanggal kadaluarsa kartu pembayaran dan rekening
              tersebut, sebagaimana berlaku.
            </li>
          </ol>
          <p>
            Informasi yang dikumpulkan setiap kali anda menggunakan Aplikasi
            atau mengunjungi situs web kami
          </p>
          <p>
            Setiap kali anda menggunakan Aplikasi atau mengunjungi situs web
            kami, kami dapat mengumpulkan data teknis tertentu sehubungan dengan
            ...
            kunjungan/sesi, identitas perangkat internet atau alamat kontrol
            akses media, dan mobile advertising ID dan informasi perangkat
            lainnya termasuk informasi mengenai produsen, model, dan sistem
            operasi dari perangkat yang anda gunakan untuk mengakses Aplikasi
            atau situs web kami.
          </p>
          <p>
            ...
            internet anda untuk menolak beberapa jenis cookies atau cookies
            spesifik tertentu. Perangkat seluler dan/atau peramban anda juga
            memungkinkan anda untuk menghapus cookies apa pun yang sebelumnya
            telah tersimpan. Namun demikian, hal itu dapat mempengaruhi
            fungsi-fungsi yang tersedia pada Aplikasi atau situs web kami.
          </p>
          <p>
            Setiap kali anda menggunakan Aplikasi melalui perangkat seluler,
            kami akan melacak dan mengumpulkan informasi lokasi geografis anda
            dalam waktu sebenarnya. Dalam beberapa kasus, anda akan diminta atau
            ...
            anda pengalaman yang lebih baik dalam menggunakan Aplikasi
            (misalnya, untuk memberikan informasi tentang seberapa dekat
            penyedia layanan dengan anda). Anda dapat menonaktifkan informasi
            pelacakan lokasi geografis pada perangkat seluler anda untuk
            sementara waktu. Namun, hal ini dapat mempengaruhi fungsi-fungsi
          ...
          <p>
            ...
            informasi tertentu terkait dengan sumber dana yang anda gunakan
            untuk melakukan isi ulang (termasuk rincian rekening bank), rincian
            rekening penerima penarikan, riwayat transaksi (termasuk detail
            penerima), rincian tagihan, faktur, dan nomor telepon.
          </p>
          <p>
          ...
          <p>
            ...
            menghubungkan kartu pembayaran atau rekening anda pada Aplikasi,
            kami dapat mengumpulkan informasi keuangan tertentu dan catatan
            finansial anda (termasuk tetapi tidak terbatas pada catatan
            transaksi, rincian dan penempatan kartu pembayaran atau rekening,
            dan/atau status dan negara kartu pembayaran atau rekening anda) dari
            penerbit kredensial pembayaran tersebut atau dari pihak ketiga
            lainnya.
          </p>
          <p>Informasi tentang pihak ketiga yang anda berikan kepada kami</p>
          <p>
            ...
            mereka terlebih dahulu untuk melakukannya - lihat “Pengakuan dan
          ...
          <p>
            ...
            tersebut merupakan diskresi dari penyedia layanan. Kami tidak
            memiliki kendali atas pengumpulan Informasi Pribadi tersebut oleh
            penyedia layanan dan setiap penggunaan atau pengungkapan oleh
            penyedia layanan dari Informasi Pribadi yang dikumpulkan. Jika anda
            adalah penyedia layanan dan memilih untuk mengunduh dan menggunakan
            perangkat rekaman di dalam kendaraan tersebut di kendaraan anda,
            anda bertanggung jawab sepenuhnya untuk memberitahukan pengguna.
            Jika anda adalah seorang pengguna dan anda keberatan atas penggunaan
            alat perekam dalam kendaraan penyedia layanan, anda harus
            menyampaikan hal tersebut kepada penyedia layanan secara langsung
            dan hal tersebut menjadi tanggung jawab pribadi anda.
          </p>
          <p>
            Jika anda menggunakan fitur pesan di Aplikasi kami, anda akan
            memberikan nomor telefon pengguna kami yang tersimpan di kontak
            telefon selular untuk membantu anda dalam menggunakan fitur pesan
            kami serta tujuan internal lainnya.
          </p>
        </p>
        ...
        <p className="text-justify" style={{ marginLeft: 30 }}>
          ...
          <div className="mt-1 ml-3 mb-0">
            <p>
              a. Jika anda adalah pengguna, kami dapat menggunakan Informasi
              Pribadi anda:
              <ul>
                <li>
                ...
                <li>
                  ...
                  transaksi yang dilakukan melalui kartu pembayaran atau
                  rekening yang tersedia pada Aplikasi;
                </li>
                <li>
            ...
            <p  >
              ...
              <ul>
                ...
                <li>
                  ...
                  dapat mendaftarkan anda sebagai penyedia layanan, termasuk
                  untuk KYC (Know Your Customer) dan penilaian kredit (credit
                  scoring);
                </li>
                <li>
                ...
                <li>
                  untuk memantau dan menganalisis aktivitas, perilaku, dan data
                  demografis pengguna termasuk kebiasaan dan daya tanggap
                  penyedia layanan untuk berbagai layanan yang tersedia pada
                  Aplikasi;
                </li>
                <li>untuk memproses dan mengelola reward points anda;</li>
                <li>
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      termasuk namun tidak terbatas pada menanggapi permintaan,
                      penyelidikan, atau arahan peraturan, mematuhi persyaratan
                      pengarsipan, pelaporan, dan perizinan yang disyaratkan
                      oleh peraturan yang berlaku) dan melakukan pemeriksaan
                      audit, uji tuntas dan penyelidikan.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
            ...
            <p className="ml-1">
              ...
              serta untuk tujuan lain yang diizinkan oleh peraturan
              ...
              <ul>
                ...
                <li>
                  ...
                  pedoman, atau mematuhi persyaratan atau ketentuan pengarsipan
                  dan pelaporan berdasarkan undang-undang), untuk tujuan yang
                ...
                <li>
                  ...
                  termasuk proses KYC (Know Your Customer) dan penentuan kredit
                  (credit scoring);
                </li>
                <li>
                  dalam keadaan darurat terkait keselamatan anda (baik anda
                  adalah pengguna atau penyedia layanan) untuk keperluan
                  menangani keadaan darurat tersebut;
                </li>
                <li>
                  dalam situasi terkait kesehatan anda atau kepentingan umum
                  (baik anda adalah pengguna atau penyedia layanan), kami dapat
                  membagikan Informasi Pribadi anda kepada pemerintah yang
                  berwenang dan/atau institusi lainnya yang dapat ditunjuk oleh
                  pemerintah yang berwenang atau memiliki kerja sama dengan
                  kami, untuk tujuan pelacakan kontak, mendukung inisiatif,
                  kebijakan atau program pemerintah, kesehatan public dan tujuan
                ...
                <li>
                  ...
                  lain, untuk keperluan transaksi tersebut (bahkan jika kemudian
                  transaksi tidak dilanjutkan);
                </li>
                <li>
                  ...
                  kepada perusahaan asuransi yang bekerja sama atau
                ...
                <li>
                  ...
                  pihak ketiga tersebut (tergantung keadaannya), yang dapat
                  mencakup diperbolehkannya pihak ketiga tersebut untuk
                  memperkenalkan atau menawarkan produk atau layanan kepada
                  anda, melakukan autentikasi terhadap anda atau menghubungkan
                  anda dengan Akun atau melakukan kegiatan lain termasuk
                  pemasaran, penelitian, analisis dan pengembangan produk; dan
                </li>
                <li>
                  dalam hal kami berbagi Informasi Pribadi dengan afiliasi, kami
                  akan melakukannya dengan maksud agar mereka membantu kami
                  dalam menyediakan Aplikasi, untuk mengoperasikan bisnis kami
                  (termasuk, ketika anda berlangganan milis kami, untuk tujuan
                  pemasaran langsung), atau untuk tujuan pengolahan data atas
                  nama kami. Misalnya, sebuah afiliasi Gojek di negara lain
                  dapat mengolah dan/atau menyimpan Informasi Pribadi anda atas
                  nama perusahaan grup Gojek di negara anda. Semua afiliasi kami
                  berkomitmen untuk mengolah Informasi Pribadi yang mereka
                  terima dari kami sesuai dengan Kebijakan Privasi dan peraturan
          ...
          <h5 className="text-left">4. Penyimpanan Informasi Pribadi</h5>
          <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
            <p>a. </p>
            <p className="ml-1">
              Informasi Pribadi anda hanya akan disimpan selama diperlukan untuk
              memenuhi tujuan dari pengumpulannya, atau selama penyimpanan
              tersebut diperlukan atau diperbolehkan oleh peraturan
              perundang-undangan yang berlaku. Kami akan berhenti menyimpan
              Informasi Pribadi, atau menghapus maksud dari dikaitkannya
              Informasi Pribadi tersebut dengan anda sebagai individu, segera
              setelah dianggap bahwa tujuan pengumpulan Informasi Pribadi
              tersebut tidak lagi dibutuhkan dengan menyimpan Informasi Pribadi
              dan penyimpanan tidak lagi diperlukan untuk tujuan bisnis atau
              secara hukum.
            </p>
          </div>
          <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
            ...
            <p className="ml-1">
              ...
              dan/atau institusi lainnya yang dapat ditunjuk oleh pemerintah
              yang berwenang atau memiliki kerja sama dengan kami, anda
              menyetujui dan mengakui bahwa penyimpanan Informasi Pribadi anda
              oleh institusi terkait akan mengikuti kebijakan penyimpanan data
              masing-masing institusi tersebut. Informasi yang disampaikan
              melalui komunikasi antara pengguna dan penyedia layanan yang
              dilakukan selain melalui penggunaan Aplikasi (seperti melalui
              panggilan telepon, SMS, pesan seluler atau cara komunikasi lainnya
              dan pengumpulan atas Informasi Pribadi anda oleh agen kami) juga
              dapat disimpan dengan beberapa cara. Kami tidak mengizinkan
              penyimpanan Informasi Pribadi dengan cara demikian dan kami tidak
              bertanggung jawab kepada anda untuk hal tersebut. Kami tidak akan
              bertanggung jawab atas penyimpanan Informasi Pribadi anda. Anda
              setuju untuk mengganti rugi, membela, dan membebaskan kami,
              pejabat, direktur, karyawan, agen, mitra, pemasok, kontraktor, dan
              afiliasi kami dari dan terhadap setiap dan segala klaim, kerugian,
              kewajiban, biaya, kerusakan, dan ongkos (termasuk tetapi tidak
              terbatas pada biaya hukum dan pengeluaran biaya ganti rugi penuh)
              yang dihasilkan secara langsung atau tidak langsung dari setiap
              penyimpanan yang tidak sah atas Informasi Pribadi anda.
            </p>
          </div>
        </p>
        <h5 className="text-left ">5. Kebijakan Privasi</h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          <p>a. </p>
          <p className="ml-1">
            ...
            Pribadi anda yang berada dalam kepemilikan dan penguasaan kami,
            dengan menghubungi kami di perincian yang disediakan di bawah ini.
          </p>
        </div>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          <p>b. </p>
        ...
        <h5 className="text-left ">
          6. empat kami menyimpan Informasi Pribadi anda
        </h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          <p>a. </p>
          <p className="ml-1">
            ...
            mentransfer Informasi Pribadi anda dari negara asal (“Negara Asal”)
            ke Negara Tujuan untuk membuat anda dapat mengakses dan memastikan
            pengalaman pelanggan yang lancar ketiga Anda menggunakan Aplikasi
            kami di luar negeri. Dalam hal tersebut, kami akan meminta
            persetujuan anda untuk mentransfer Data Pribadi anda dari Negara
            Asal ke Negara Tujuan untuk memastikan kepatuhan atas hukum dan
        ...
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          ...
          <p className="ml-1">
            ...
            ditransfer, atau diolah oleh penyedia layanan pihak ketiga. Kami
            akan menggunakan semua upaya yang wajar untuk memastikan bahwa semua
            penyedia layanan pihak ketiga tersebut memberikan tingkat
            perlindungan yang sebanding dengan komitmen kami berdasarkan
        ...
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          ...
          <p className="ml-1">
            ...
            menggunakan seluruh usaha yang terbaik untuk memastikan Afiliasi
            kami di negara lain dan seluruh pihak ketiga pemberi layanan
            memberikan tingkat perlindungan yang setara dengan komitmen kami
            dalam Kebijakan Privasi ini.
          </p>
        </div>
        <h5 className="text-left"> 7. Keamanan Informasi Pribadi anda</h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          ...
          penggunaan atau pengungkapan oleh orang-orang yang tidak berwenang dan
          dari pengolahan yang bertentangan dengan hukum, kehilangan yang tidak
          ...
          keakuratan Informasi Pribadi apa pun yang anda kirimkan melalui
          ...
          anda, termasuk kata sandi anda dan One Time Password (OTP) dengan
          siapapun dan harus selalu menjaga dan bertanggung jawab atas keamanan
          perangkat yang anda gunakan
        </div>
        <h5 className="text-left"> 8. Perubahan atas Kebijakan Privasi ini</h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
          ...
          <ul className="text-left">
            <ol>
              ...
              <li>
                ...
                di bawah ini. Anda juga dapat menarik persetujuan pengiriman
                komunikasi dan informasi tertentu dari kami melalui fasilitas
                "opt-out" atau pilihan "berhenti berlangganan" yang tersedia
                dalam pesan kami kepada anda. Tergantung pada keadaan dan sifat
                ...
                lagi dapat menggunakan Aplikasi atau layanan. Penarikan
                persetujuan anda dapat mengakibatkan penghentian Akun anda atau
                hubungan kontraktual anda dengan kami, dengan semua hak dan
                kewajiban yang muncul sepenuhnya harus dipenuhi. Setelah
        ...
        <h5 className="text-left"> 10. Materi pemasaran dan promosi</h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
        ...
        <h5 className="text-left"> 11. Data anonim</h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
        ...
        <h5 className="text-left"> 12. Platform pihak ketiga</h5>
        <div className="d-flex text-justify" style={{ marginLeft: 32 }}>
