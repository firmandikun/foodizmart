  ...
  return (
    <div>
      ...
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Ketentuan Penggunaan ini adalah perjanjian antara pengguna (“Anda”) dan
        PT XXXX____XXXX (“Kami”), sebuah perseroan terbatas yang didirikan dan
        beroperasi secara sah berdasarkan hukum negara Republik Indonesia dan
        berdomisili di DI Yogyakarta, Indonesia. Ketentuan Penggunaan ini
        mengatur akses dan penggunaan Anda atas aplikasi, situs web
        (www.foodizmart.id dan situs web lain yang Kami kelola), konten dan
        produk yang disediakan oleh Kami (selanjutnya, secara bersama-sama
        disebut sebagai “Aplikasi”), serta pemesanan, pembayaran atau penggunaan
        layanan yang tersedia pada Aplikasi (“Layanan”). Dengan menyetujui
        Ketentuan Penggunaan ini, Anda juga menyetujui Ketentuan Penggunaan
        tambahan, termasuk Ketentuan Penggunaan pada setiap Layanan, dan
        perubahannya yang merupakan bagian yang tidak terpisahkan dari Ketentuan
        Penggunaan ini (selanjutnya, Ketentuan Penggunaan, Ketentuan Penggunaan
        tambahan, dan perubahannya secara bersama-sama disebut sebagai
        “Ketentuan Penggunaan”). Meskipun merupakan satu kesatuan, Ketentuan
        Penggunaan tambahan akan berlaku dalam hal terdapat perbedaan dengan
        Ketentuan Penggunaan.
      </p>

      <h5 className="text-left"> 2. Istilah Umum</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        <ul className="mt-2">
          <li>
            <b>Gerai </b> adalah restoran, rumah makan, warung toko, gerobak
            dan/atau bentuk fisik lainnya yang terdaftar dalam Aplikasi
            Foodizmart yang dimiliki dan dikelola oleh Merchant.
          </li>
          <li>
            <b>Merchant</b> adalah pihak yang memiliki dan mengelola Gerai
            dimana bertindak sebagai penyedia Produk.
          </li>
          <li>
            <b> Mitra </b> adalah Penyedia Layanan pihak ketiga independen yang
            setuju menjadi mitra Kami, bekerja sama dengan Kami dengan skema
            kemitraan, dan bukan karyawan, agen atau perwakilan Kami.
          </li>
          <li>
            <b> Produk</b> adalah makanan dan/atau minuman yang Anda pesan
            melalui Layanan Foodizmart di Gerai yang Anda pilih.
          </li>
          <li>
            <b>Transaksi</b> adalah pemesanan, pembelian dan pengantaran atas
            Produk melalui Aplikasi.
          </li>
        </ul>
      </p>

      <h5 className="text-left">3. Penggunaan Aplikasi dan Layanan</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
      ...
      <h5 className="text-left">4. Pembukaan dan Pengaksesan Akun</h5>

      <p className="text-justify" style={{ marginLeft: 32 }}>
        Sebelum menggunakan Aplikasi, Anda harus menyetujui Ketentuan Penggunaan
        ini dan Kebijakan Privasi, dan mendaftarkan diri Anda dengan memberikan
        informasi yang dibutuhkan oleh Kami. Saat melakukan pendaftaran, Kami
        akan meminta Anda untuk memberikan nama lengkap, alamat email, dan nomor
        telepon seluler pribadi Anda yang sah. Anda dapat mengubah informasi
        data diri Anda pada fitur pengaturan dalam Aplikasi.
        <p>
          Setelah melakukan pendaftaran, sistem Kami akan menghasilkan kode
          verifikasi secara otomatis dan mengirim kode verifikasi tersebut
        ...
        <p>Fitur Otentikasi Perangkat</p>
        <p>
      ...
      <h5 className="text-left">5. Akun Anda</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        Anda digunakan oleh orang lain.
        <p>
          Keamanan dan kerahasiaan Akun Anda, termasuk nama terdaftar, alamat
          surat elektronik terdaftar, nomor telepon genggam terdaftar, rincian
          pembayaran dan Metode Pembayaran yang Anda pilih, serta kode
          verifikasi yang dihasilkan dan dikirim oleh sistem Kami atau Penyedia
          Metode Pembayaran sepenuhnya merupakan tanggung jawab pribadi Anda.
          Semua kerugian dan risiko yang ada akibat kelalaian Anda menjaga
          keamanan dan kerahasiaan sebagaimana disebutkan ditanggung oleh Anda
          sendiri. Dalam hal demikian, Kami akan menganggap setiap penggunaan
          atau pesanan yang dilakukan melalui Akun Anda sebagai permintaan yang
          sah dari Anda.
        </p>
        <p>
      ...
      <h5 className="text-left">6.Informasi Pribadi</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Pengumpulan, penyimpanan, pengolahan, penggunaan dan pembagian informasi
        pribadi Anda, seperti nama, alamat surat elektronik, dan nomor telepon
        genggam Anda yang Anda berikan ketika Anda membuka Akun tunduk pada
        Kebijakan Privasi, yang merupakan bagian yang tidak terpisahkan dari
        Ketentuan Penggunaan ini.{" "}
      </p>
      <h5 className="text-left">7.Konten, Informasi dan Promosi</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        Konten Pihak Ketiga disediakan oleh pihak lain yang bekerja sama dengan
        Kami (“Penyedia Konten Pihak Ketiga”), Kami tidak bertanggung jawab atas
        bagian apapun dari isi Konten Pihak Ketiga. Akses atau penggunaan Anda
        terhadap Konten Pihak Ketiga tersebut merupakan bentuk persetujuan Anda
        untuk tunduk pada syarat dan ketentuan yang ditetapkan oleh Kami atau
        Penyedia Konten Pihak Ketiga, termasuk terhadap Kebijakan Privasi Kami
      ...
      <h5 className="text-left">8. Pemesanan</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
      ...
      <h5 className="text-left">9. Biaya dan Pembayaran</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Pengunduhan perangkat lunak dan penggunaan Aplikasi adalah bebas biaya.
        Namun, Kami dapat mengenakan biaya untuk penggunaan fitur tertentu pada
        ...
        <p>
          ...
          berdasarkan faktor tertentu, antara lain lokasi, waktu, jenis Layanan
          dan peraturan perundang-undangan yang berlaku. Kami juga dapat
          membebankan harga dan/atau biaya dengan besaran tertentu sebagai
          pembayaran untuk penggunaan Aplikasi yang dapat dipungut oleh Kami,
          afiliasi Kami, atau Penyedia Layanan.
        </p>
        <p>
      ...
      <h5 className="text-left">10. Pengantaran</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Anda atau pihak lainnya yang Anda tunjuk untuk menerima Produk memahami
        untuk membuat dirinya tersedia, dapat dihubungi dan dapat menerima pada
        saat Produk diantarkan oleh Mitra.
        <p>
          Anda dapat memberikan ulasan atas Produk sebagaimana terdapat dalam
          Layanan Foodizmart setelah Transaksi Anda selesai.
        </p>
        <p>
        ...
        <ol>
          <li>
            perbedaan harga yang tercantum di Layanan Foodizmart dan Gerai;
          </li>
      ...
      <h5 className="text-left">11.Perangkat Lunak Aplikasi</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Kami hanya menyediakan perangkat lunak Aplikasi yang resmi pada pasar
        digital resmi, seperti Google Play Store atau Apple App Store, dan untuk
        digunakan hanya pada perangkat telepon genggam atau tablet. Mengunduh
        Aplikasi dari tempat lain selain pasar digital resmi dan/atau ke dalam
        perangkat lain selain telepon genggam atau tablet merupakan pelanggaran
        terhadap Ketentuan Penggunaan ini dan terhadap hak kekayaan intelektual
        Kami.
      </p>
      <h5 className="text-left">12.Kekayaan Intelektual</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        pemberi lisensi Kami) memiliki seluruh hak dan kepentingan atas Aplikasi
        dan Layanan, termasuk seluruh hak kekayaan intelektual terkait dengan
        seluruh fitur yang terdapat didalamnya dan hak kekayaan intelektual
        terkait.
        <p>
          ...
          menggunakan Aplikasi, sebagaimana adanya, hanya pada perangkat berupa
          telepon genggam dan/atau tablet pribadi Anda dan hanya untuk keperluan
          terkait penggunaan Layanan, dan (ii) mengakses atau menggunakan
          konten, informasi dan materi terkait yang tersedia pada Aplikasi hanya
          untuk kepentingan pribadi dan bukan tujuan komersial. Hak dan hak
          istimewa lainnya yang tidak secara tegas diberikan dalam Ketentuan
          Penggunaan ini, adalah hak Kami atau pemberi lisensi Kami.
          <p>
          ...
          <p>Hal yang tidak boleh Anda lakukan antara lain :</p>
      ...
      <h5 className="text-left">13.Tanggung Jawab Anda</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        Metode Pembayaran dengan hormat dan tidak boleh terlibat dalam perilaku
        atau tindakan yang tidak sah, mengancam atau melecehkan ketika
        menggunakan Layanan, Konten Pihak Ketiga, Penawaran atau Metode
        Pembayaran.
        <p>
      ...
      <h5 className="text-left">14.Batasan Tanggung Jawab Kami</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        dilakukan oleh Penyedia Layanan, Penyedia Konten Pihak Ketiga, Penyedia
        Penawaran atau Penyedia Metode Pembayaran ataupun kegagalan atau
        kesalahan Anda dalam mematuhi Ketentuan Penggunaan Kami, Penyedia
        Layanan, Penyedia Konten Pihak Ketiga, Penyedia Penawaran atau Penyedia
        Metode Pembayaran.
        <p>
      ...
      <h5 className="text-left">15.Penyelesaian Masalah</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        dicuri, diretas atau terkena virus, segera laporkan kepada Kami sehingga
        Kami dapat segera mengambil tindakan yang diperlukan untuk menghindari
        penggunaan, penyalahgunaan, atau kerugian yang timbul atau mungkin
        timbul lebih lanjut.
        <p>
      ...
      <h5 className="text-left">
        16.Pembekuan Sementara dan Pembekuan Permanen Akun
      </h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Anda dapat menghapus Aplikasi dari telepon genggam dan/atau tablet Anda
        setiap saat. Kami tidak memiliki kewajiban apapun kepada Anda terhadap
        hal-hal yang timbul sejak penghapusan Aplikasi, pembekuan sementara atau
        pembekuan permanen Akun Anda. Akan tetapi, Anda tetap bertanggung jawab
        untuk menyelesaikan kewajiban-kewajiban Anda yang telah timbul, termasuk
        namun tidak terbatas pada, setiap kewajiban yang mungkin timbul akibat
        adanya sengketa, tuntutan, maupun tindakan hukum lainnya yang telah ada,
        sebelum tanggal penghapusan Aplikasi, pembekuan sementara atau pembekuan
        permanen Akun Anda.
        <p>
        ...
        <ol className="text-left">
          ...
          <li>
            Laporan Anda bahwa telepon genggam atau tablet pribadi Anda hilang,
            dicuri atau diretas;
          </li>
          <li>
            Kami mengetahui atau mempunyai alasan yang cukup untuk menduga bahwa
            Akun Anda telah dialihkan atau digunakan oleh orang lain;
          </li>
          <li>
          ...
          <li>
            ...
            Anda tidak cakap hukum berdasarkan peraturan perundang-undangan yang
            berlaku;
          </li>
          <li>
        ...
        <p>
          Jika Akun Anda dibekukan dan Anda memiliki bukti yang jelas bahwa Akun
          Anda seharusnya tidak dibekukan, Anda dapat membuat Laporan kepada
          Kami untuk menyampaikan bukti-bukti tersebut. Setelah melakukan
          pemeriksaan lebih lanjut terhadap Laporan Anda, Kami akan, atas
          kebijakan Kami sepenuhnya, menentukan untuk mengakhiri atau
        ...
        <p>
          ...
          dimanufaktur tanpa persetujuan penyedia layanan perangkat. Penggunaan
          Aplikasi pada perangkat rooted atau jail-broken dapat mengkompromisasi
          keamanan dan berujung pada transaksi penipuan.
        </p>
        <p>
          Kami tidak bertanggung jawab atas pengunduhan dan penggunaan Aplikasi
          pada perangkat rooted atau jail-broken dan resiko penggunaan anda
          terhadap perangkat rooted atau jail-broken sepenuhnya adalah resiko
          anda. Anda mengerti dan setuju bahwa Kami tidak bertanggung jawab atas
          segala kehilangan atau setiap konsekuensi lain yang diderita atau
          disebabkan oleh anda sebagai akibat dari penggunaan aplikasi Kami pada
          perangkat rooted atau jail-broken dan Kami mempunyai diskresi untuk
          menghentikan Penggunaan Anda terhadap Aplikasi pada perangkat rooted
          atau jail-broken dan memblokirperangkat rooted atau jail-broken untuk
          menggunakan Aplikasi.
        </p>
      </p>
      <h5 className="text-left">17.Tindakan yan Kami Anggap Perlu</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Apabila Kami mengetahui atau mempunyai alasan yang cukup untuk menduga
        bahwa Anda telah melakukan tindakan asusila, pelanggaran, kejahatan atau
        tindakan lain yang bertentangan dengan Ketentuan Penggunaan ini dan/atau
        peraturan perundang-undangan yang berlaku, baik yang dirujuk dalam
        Ketentuan Penggunaan ini atau tidak, maka Kami berhak untuk dan dapat
        membekukan Akun, baik sementara atau permanen, atau menghentikan akses
        Anda terhadap Aplikasi, termasuk Layanan, Konten Pihak Ketiga, Penawaran
        dan/atau Metode Pembayaran yang terdapat di dalamnya, melakukan
        pemeriksaan, menuntut ganti kerugian, melaporkan kepada pihak berwenang
        dan/atau mengambil tindakan lain yang kami anggap perlu, termasuk
        ...
        <ol>
          <li>
            Pelecehan atau kekerasan verbal, termasuk namun tidak terbatas pada,
            atas fisik, jenis kelamin, suku, agama dan ras, yang Anda lakukan
        ...
        <p>
          Ketentuan ini juga berlaku sebaliknya apabila Anda mengalami tindakan
          sebagaimana disebutkan di atas yang dilakukan oleh Penyedia Layanan
          terhadap Anda.
        </p>
      </p>
      <h5 className="text-left">18.Pernyataan Anda</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        <p>
        ...
        <p>
          Anda setuju untuk mengakses atau menggunakan Aplikasi, Layanan, Konten
          Pihak Ketiga, Penawaran atau Metode Pembayaran hanya untuk tujuan
          sebagaimana ditentukan dalam Ketentuan Penggunaan ini dan tidak
          menyalahgunakan atau menggunakan Aplikasi, Layanan, Konten Pihak
          Ketiga, Penawaran atau Metode Pembayaran untuk tujuan penipuan,
          menyebabkan ketidaknyamanan kepada orang lain, melakukan pemesanan
          palsu atau yang tindakan-tindakan lain yang dapat atau dianggap dapat
        ...
        <p>
          ...
          setuju dan secara tegas membatasi jumlah tuntutan Anda sebesar jumlah
          keseluruhan yang senyatanya ditimbulkan atau telah dibayarkan
          sehubungan dengan peristiwa tersebut.
        </p>
        <p>
          ANDA MENGAKUI BAHWA KAMI ADALAH PERUSAHAAN TEKNOLOGI, BUKAN PERUSAHAAN
          TRANSPORTASI, KURIR, POS, JASA PENGANTARAN, LOGISTIK, KEUANGAN DAN
          LAIN-LAIN DAN KAMI TIDAK MEMBERIKAN LAYANAN TRANSPORTASI, KURIR, POS,
          JASA PENGANTARAN, LOGISTIK, KEUANGAN DAN LAYANAN LAIN. SEMUA LAYANAN
          TRANSPORTASI, KURIR, POS, JASA PENGANTARAN, LOGISTIK, KEUANGAN DAN
          LAYANAN LAIN DISEDIAKAN PIHAK KETIGA INDEPENDEN YANG TIDAK
        ...
        <p>
          ...
          PENAWARAN ATAU PENYEDIA METODE PEMBAYARAN. SEGERA HENTIKAN AKSES ATAU
          PENGGUNAAN APLIKASI GOJEK DAN/ATAU LAYANAN JIKA ANDA TIDAK SETUJU
          DENGAN BAGIAN APAPUN DARI KETENTUAN PENGGUNAAN INI.
        </p>
      </p>
      <h5 className="text-left">19.Keadaan Kahar</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        Aplikasi dapat diinterupsi oleh kejadian di luar kewenangan atau kontrol
        Kami (“Keadaan Kahar”), termasuk namun tidak terbatas pada bencana alam,
        gangguan listrik, gangguan telekomunikasi, kebijakan pemerintah, dan
      ...
      <h5 className="text-left">20.Lain-lain</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
        ...
        Akun Anda merupakan persetujuan aktif Anda untuk mengikatkan diri dalam
        perjanjian dengan Kami sehingga keberlakuan Ketentuan Penggunaan ini dan
        Kebijakan Privasi adalah sah dan mengikat secara hukum dan terus berlaku
        sepanjang penggunaan Aplikasi dan Layanan oleh Anda.
        <p>
      ...
      <h5 className="text-left">21.Cara Menghubungi Kami</h5>
      <p className="text-justify" style={{ marginLeft: 32 }}>
